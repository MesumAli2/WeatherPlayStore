package com.mesum.weather.ui.favourites
...
import com.mesum.weather.Database.favdb.FavCitys
...
@HiltViewModel
class  FavoriteViewModel @Inject constructor(val repository: FavCityRepository) : ViewModel() {
